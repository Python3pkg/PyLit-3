...
time_benchmark(loop, wrappers, list(range(1000)))
print()
time_benchmark(peek_before_loop, peekables, list(range(1000)))
print()
time_benchmark(peek_in_loop, peekables, list(range(1000)))
print()
time_benchmark(bool_before_loop, state_reporters, list(range(1000)))
print()
time_benchmark(bool_in_loop, state_reporters, list(range(1000)))
